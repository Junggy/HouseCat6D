...
if __name__ == "__main__":
    import gorilla
    cfg = gorilla.Config.fromfile('../config/base.yaml')
    house = TrainingDataset(cfg.train_dataset,
        'real',
        'r',
    ...
    house = TestDataset(cfg.test, 'test_trainedwithMask', resolution=cfg.resolution,)
    b = house[0]