...
from provider.housecat6d_dataset_new import HouseCat6DTrainingDataset
...
def init():
    ...
    if cfg.mode == 'ts':
        ...
        cfg.log_dir = os.path.join(log_dir_dataset, 'VI_Net')
    else:
...
if __name__ == "__main__":
    ...
    if cfg.mode == 'r':
        from model.VI_Net_pol import Net, Loss
    ...
    # dataloader
    dataset = HouseCat6DTrainingDataset(
        cfg.train_dataset,
        cfg.dataset,
        cfg.mode,
